...
#include "../../../GirEngine/GraphicsIR/RenderGraphIR/RenderGraphIR.hpp"
...
namespace pEngine::girEngine::backend::vulkan {
    ...
    public:
        ...
        VulkanBackend(VulkanBackend &other);
        ...
        std::shared_ptr<VulkanApplicationContext> getApplicationContext() const {
            return std::dynamic_pointer_cast<VulkanApplicationContext>(applicationContext);
        }
        ...
        ConsumeResult consumeGirs(const frontend::BakeOutput &girList) override;
    ...
    private:
        ...
        VkPipelineRenderingCreateInfo getPipelineRenderingCreateInfo(const RenderPassIR *ptr);
