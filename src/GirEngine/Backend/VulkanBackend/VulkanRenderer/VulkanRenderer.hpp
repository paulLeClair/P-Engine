...
namespace pEngine::girEngine::backend::vulkan {
    ...
    public:
        struct CreationInput {
            ...
            std::shared_ptr<vulkan::VulkanApplicationContext> applicationContext;
        ...
        void setGuiCallbacks(std::vector<std::function<void()> > &&callbacks);
        ...
        [[nodiscard]] VulkanPresentationEngine &getPresentationEngine() {
            return presentationEngine;
        }

        [[nodiscard]] std::shared_ptr<vulkan::VulkanApplicationContext> getApplicationContext() {
        ...
        void allocateAndRecordFrameInitCommandBuffer(VkCommandBuffer &frameInitCommandBuffer);
    ...
    private:
        ...
        std::unique_ptr<VulkanGuiContext> guiThread;
        ...
        void freePreviouslyUsedCommandBuffers(VkCommandPool commandPool);
