...
namespace pEngine::girEngine::scene {
    Scene::Scene(const CreationInput &creationInput)
        : space({}), swapchainRenderTarget(SwapchainRenderTarget::CreationInput{
        ...
        space = space::SceneSpace(space::SceneSpace::CreationInput{
            space::SpaceVolumeOptions::INFINITE_VOLUME
        });
    }

    frontend::BakeOutput Scene::bakeToGirs() {
