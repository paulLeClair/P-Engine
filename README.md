...
There will be a big "re-architecture" PR that will be pushed soon where a lot of these overly OOP-y designs will be made more concrete and the APIs for each existing module will be finalized.
