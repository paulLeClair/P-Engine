...
#include "../../../Application/OSInterface/OSWindow/XLibWindow/XLibWindow.hpp"
#endif
...
#include "../../../Application/OSInterface/OSWindow/OSWindow.h"
...
namespace pEngine::girEngine::backend::vulkan {
    ...
    class VulkanOSInterface final : public app::OSInterface {
    public:
        struct CreationInput : OSInterface::CreationInput {
            VkInstance instance{};
        ...
        ~VulkanOSInterface() override;

        [[nodiscard]] VkRect2D getRenderArea() const;

        [[nodiscard]] WindowPlatform getWindowPlatform() const override {
        ...
        std::shared_ptr<backend::vulkan::VulkanSwapchain> &getSwapchain() {
            return vulkanSwapchain;
        }

#ifdef _WIN32

        std::shared_ptr<app::Win32Window> getWin32Window() {
            return std::dynamic_pointer_cast<app::Win32Window>(window);
        }
    ...
    private:
        ...
        std::shared_ptr<app::OSWindow> window;
        ...
        std::shared_ptr<backend::vulkan::VulkanSwapchain> vulkanSwapchain = nullptr;
        ...
        VkExtent2D getMinimumSwapchainImageExtent() const {
        ...
        void createSwapchain(const CreationInput &input) {
            vulkanSwapchain = std::make_shared<backend::vulkan::VulkanSwapchain>(
                backend::vulkan::VulkanSwapchain::CreationInput{
                    input.instance,
                    input.logicalDevice,
