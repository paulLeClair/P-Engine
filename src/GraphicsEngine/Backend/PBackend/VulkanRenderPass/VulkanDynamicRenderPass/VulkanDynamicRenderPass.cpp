...
namespace PGraphics {
    ...
    void VulkanDynamicRenderPass::initializeGraphicsPipeline(const VulkanDynamicRenderPass::CreationInput &createInfo) {
        ...
        VulkanGraphicsPipeline::CreateInfo graphicsPipelineCreateInfo = {
                device,
        ...
        graphicsPipeline = std::make_shared<VulkanGraphicsPipeline>(graphicsPipelineCreateInfo);
    }
    ...
    void VulkanDynamicRenderPass::recordRenderPassDrawCommandsIntoFrame(const PFrame &frame) {
        // idea: this is where a render pass will record various draw commands onto worker thread command buffers
